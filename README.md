...
How to Run hhbuilder:
1) Load hhbuilder/index.html in your browser (chrome preferred, but any browser will do) to start the program.

Application captures information about a household applying for health insurance coverage.
